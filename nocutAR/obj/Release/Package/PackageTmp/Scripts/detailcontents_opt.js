...
$(document).ready(function () {
    ...
    $("#video_file1").bind("change", function () {
        ...
        $('#video_file_text1').val(this.value.replace('C:\\fakepath\\', ''));
...
function OnVideoApply1() {
    ...
    if ($("#youVideo").val().substr(0, 22) == "http://www.youtube.com" || $("#youVideo").val().substr(0, 23) == "https://www.youtube.com") {
        var pos = $(objName).position();
        var element = '<div id="temp" style="width: 200px; height: auto; position:absolute"><video width="100%" height="100%" controls><source src="' + $("#youVideo").val() + '"></video>';
        //패널 추가
        element += panel_obj;
        ...
        videoList[index] = { url: $("#youVideo").val(), type: val, run_opt: run_opt, objsize: 0 };
    ...
    //    closePopup();
    document.getElementById("dvRegVideo").style.display = "none";
}
...
function OnThreeApply() {
    ...
    document.getElementById("dv3DObj").style.display = "none";
}
