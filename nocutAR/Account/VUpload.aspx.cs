...
namespace nocutAR.Account
{
    public partial class VUpload : Common.PageBase
    {
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                arguments = "COAR " + strType + " star_" + content_id;
            }
            else
            {
                ...
                arguments = "COAR " + strType + " star_" + content_id + " " + width + " " + strImgPath;
            }
            RunVUpload(arguments);
//            Process[] uploadProc = Process.GetProcessesByName("VuforiaUpload.exe");
//            while (uploadProc != null)
//            {
//            }
            if ("remove".Equals(strType))
            {
